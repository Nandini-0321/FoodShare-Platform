...
$data = $controller->editDonation($_GET['id']);

// Page Configuration
$pageTitle = 'Edit Donation - FoodShare';
$pageHeading = 'Edit Donation';
$userType = 'donor';
...
<div class="donation-container">
    ...
    <div class="donation-form-card animate-fade-in">
        <h2 class="mb-lg" style="font-family: var(--font-heading); display: flex; align-items: center; gap: 0.5rem;">
            <i class="fas fa-edit" style="color: var(--primary);"></i> Edit Donation
        </h2>
        
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?id=<?php echo $_GET['id']; ?>" method="POST" id="donationForm">
            ...
            <div class="form-group mb-lg">
                ...
                <input type="hidden" name="food_type" id="food_type" value="<?php echo $data['food_type']; ?>">
                <input type="hidden" name="food_category" id="food_category" value="other">
                <script>
                    document.addEventListener('DOMContentLoaded', () => {
                        selectCategory('<?php echo $data['food_type']; ?>');
                    });
                </script>
            </div>
            ...
            <!-- Hidden Image URL -->
            <input type="hidden" name="food_image_url" id="food_image_url" value="<?php echo $data['food_image_url'] ?? ''; ?>">
    ...
    <div class="preview-card-container">
        ...
        <div class="preview-card">
            <div class="preview-image-container">
                ...
                <?php
                if (!empty($data['food_image_url'])) {
                    $img_src = (strpos($data['food_image_url'], 'http') === 0) ? $data['food_image_url'] : '../../assets/images/uploads/' . $data['food_image_url'];
                } else {
                    $img_src = 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&q=80';
                }
                ?>
                <img src="<?php echo $img_src; ?>" alt="Food Preview" class="preview-image" id="preview_img">
            ...
            <div class="preview-content">
                <h3 style="font-size: 1.4rem; margin-bottom: 0.5rem;" id="preview_title"><?php echo $data['food_name'] ?? 'Your Food Title'; ?></h3>
                ...
                <p style="color: var(--text-secondary); margin: 1rem 0;" id="preview_desc">
                    <i class="fas fa-map-marker-alt"></i> <span id="preview_location"><?php echo $data['pickup_city'] ?? 'Location'; ?></span>
                </p>
